...
#%%
def calc_evpi(case_settings,RP,path_in,path_out):
    ...
    for scen in PROB.keys():
        ...
        match scen:
            case 'scen0': current_scenario = 'default'
            case 'scen1': current_scenario = 'A1'
            case 'scen2': current_scenario = 'A2'
            case _: raise ValueError("Non-identified scenario.")
        
        
        pgim_model = ReferenceModelCreator(grid_case=GRID_CASE,
